<div class="mb-4">
    <div class="flex flex-wrap mt-1">
        <div class="relative rounded-md shadow-sm flex flex-col w-full md:w-1/2 mr-4 mt-1">
        ...
        <button class="ml-2 mt-1 px-6 py-1 bg-karl-orange text-gray-800 text-center font-bold sm:rounded max-h-10"
            type="submit">
            Submit
        </button>
    </div>
    ...
    <div x-data={show:false}>
        ...
        <div x-show="show" class="mt-3">
            ...
            <div class="mt-3 flex sm:flex-row flex-wrap">
    ...
    <p class="flex">
        <a x-on:click.prevent="show=!show" class="px-6 py-1 bg-gunner text-white text-center font-bold sm:rounded max-h-10 cursor-pointer focus:outline-none mr-2 mt-2">
        Show/Hide Filters
        </a>
    </p> 
    </div>
