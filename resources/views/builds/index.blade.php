                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                <div class="text-sm leading-5 text-gray-900">
                                    ...
                                    <x-gun-icon :name="$mods[0]->gun->name" size="w-16" />
                                    @endforeach
                                </div>
                            </td>
...
{{--                                <a href="#" class="text-indigo-600 hover:text-indigo-900">Edit</a>--}}
                                <div class="flex justify-evenly">
                                    ...
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 text-gray-300 cursor-pointer" stroke="currentColor" fill="currentColor" viewBox="0 0 20 20"><path d="M10 3.22l-.61-.6a5.5 5.5 0 0 0-7.78 7.77L10 18.78l8.39-8.4a5.5 5.5 0 0 0-7.78-7.77l-.61.61z"></path></svg>
                                    </div>
                                </div>
                            </td>
                        </tr>
