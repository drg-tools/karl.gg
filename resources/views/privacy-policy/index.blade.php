@extends('layouts.app')
@section('body_class', 'body__privacy_policy')
...
<p>
<strong>Publicly Available Personal Information. </strong>We collect email addresses; and other similar data. 
</p>
<p>
...
<p>Online Identifiers. We collect tools and protocols, such as IP (Internet Protocol) addresses; and other similar data.
</p>
...
<p>
    Legitimate Interests: We may process your data when it is reasonably necessary to achieve our legitimate business interests.</p>

    <p>
    Performance of a Contract: Where we have entered into a contract with you, we may process your personal information to fulfill the terms of our contract.</p>
