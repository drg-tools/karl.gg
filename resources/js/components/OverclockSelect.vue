<template>
    ...
    <div class="overclockContainer">
        ...
        <div
            v-if="
                  this.$store.state.selectedPrimaryOverclock != '' ||
                  this.$store.state.selectedSecondaryOverclock != ''
                "
...
export default {
    ...
    methods: {
        hydrateData() {
            this.weaponOverclocks = this.$store.getters.getOcDataByWeapon(
                this.weaponId
            );
        },
        ...
        selectedOc() {
            ...
            if (selectedObject.length === 0) {
                ...
                this.selectedOverclockIcon = this.getIconPath(
                    selectedObject[0].icon
                );
