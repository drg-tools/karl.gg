...
export default new Vuex.Store({
    ...
    actions: {
        ...
        setSelectedEquipment1Mod({ commit, state }, selectedModObject) {
            let currentTierSelection = state.selectedEquipment1Mods.filter(
                (mod) =>
                    mod.selectedModTier === selectedModObject.selectedModTier
            );
            let sameSelection = false;
        ...
        setSelectedEquipment2Mod({ commit, state }, selectedModObject) {
            let currentTierSelection = state.selectedEquipment2Mods.filter(
                (mod) =>
                    mod.selectedModTier === selectedModObject.selectedModTier
            );
            let sameSelection = false;
        ...
        setSelectedEquipment3Mod({ commit, state }, selectedModObject) {
            let currentTierSelection = state.selectedEquipment3Mods.filter(
                (mod) =>
                    mod.selectedModTier === selectedModObject.selectedModTier
            );
            let sameSelection = false;
