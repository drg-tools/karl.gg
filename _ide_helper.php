...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getFieldsWithRelationType($relation_types)
        {
                        /** @var \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $instance */
                        return $instance->getFieldsWithRelationType($relation_types);
        }
                    /**
     ...
     */ 
        class LaravelRatingFacade {
                    /**
         * 
         *
         * @static 
         */ 
        public static function rate($user, $rateable, $value, $type)
        {
                        /** @var \Nagy\LaravelRating\LaravelRating $instance */
                        return $instance->rate($user, $rateable, $value, $type);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function unRate($user, $rateable, $type)
        {
                        /** @var \Nagy\LaravelRating\LaravelRating $instance */
                        return $instance->unRate($user, $rateable, $type);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function isRated($user, $rateable, $type)
        {
                        /** @var \Nagy\LaravelRating\LaravelRating $instance */
                        return $instance->isRated($user, $rateable, $type);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getRatingValue($user, $rateable, $type)
        {
                        /** @var \Nagy\LaravelRating\LaravelRating $instance */
                        return $instance->getRatingValue($user, $rateable, $type);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function resolveRatedItems($items)
        {
                        /** @var \Nagy\LaravelRating\LaravelRating $instance */
                        return $instance->resolveRatedItems($items);
        }
     ...
     */ 
         ...
         * 
         *
         * @see \LaravelFrontendPresets\TailwindCssPreset\TailwindCssPresetServiceProvider::boot()
         * @param mixed $command
         * @static 
         */ 
        public static function tailwindcss($command)
        {
...
namespace  { 
            ...
            class LaravelRatingFacade extends \Nagy\LaravelRating\LaravelRatingFacade {}
