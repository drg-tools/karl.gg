...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function rate($user, $rateable, $value)
        {
                        /** @var \Nagy\LaravelRating\LaravelRating $instance */
                        return $instance->rate($user, $rateable, $value);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function isRated($user, $rateable)
        {
                        /** @var \Nagy\LaravelRating\LaravelRating $instance */
                        return $instance->isRated($user, $rateable);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getRatingValue($user, $rateable)
        {
                        /** @var \Nagy\LaravelRating\LaravelRating $instance */
                        return $instance->getRatingValue($user, $rateable);
        }
                    /**
         * 
         *
...
namespace  { 
            ...
            class LaravelRating extends \Nagy\LaravelRating\LaravelRatingFacade {}
